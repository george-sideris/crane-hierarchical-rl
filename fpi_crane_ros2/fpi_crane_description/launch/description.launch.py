...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'use_sim_time',
            default_value='false',
            description='Use the /clock topic (set true when replaying a rosbag with --clock).',
        ),
        DeclareLaunchArgument(
            'replay',
            default_value='false',
            description='Emit zed_0 camera-internal frames in the URDF (for rosbag replay without the ZED driver).',
        ),
