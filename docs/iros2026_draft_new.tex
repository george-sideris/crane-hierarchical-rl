...
\begin{table*}[t]
\centering
\caption{Robustness evaluation under domain randomization (DR), observation noise, and their combination (mean $\pm$ std over 100 episodes). DR varies log friction, mass, and spawn pattern; observation noise adds Gaussian perturbations ($\sigma=0.01$) to the point cloud.}
