...
# Alignment
ax1.plot(theta, alignment_raw, "--", color="C0", linewidth=0.8, alpha=0.5, label=r"$\cos\theta_\alpha$")
ax1.plot(theta, alignment, color="C0", linewidth=1.5, label=r"$(\cos\theta_\alpha)^8$")
ax1.set_xlabel(r"Misalignment angle $\theta_\alpha$ (deg)")
ax1.set_ylabel("Score")
ax1.set_title(r"Alignment $\alpha$")
