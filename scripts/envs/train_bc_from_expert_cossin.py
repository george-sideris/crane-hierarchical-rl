#!/usr/bin/env python3
"""
Behavioral Cloning from Expert Heuristic - Cos/Sin Yaw Encoding

Collects demonstrations from the expert heuristic and trains a BC policy.
Uses 5D action space [x, y, z, cos(2*yaw), sin(2*yaw)] with cos/sin encoding
to handle π-periodicity (log symmetry).

Based on Morrison et al. / Kumra et al. grasp detection papers.

Usage:
    ./isaaclab.sh -p crane_testbed/scripts/envs/train_bc_from_expert_cossin.py \
